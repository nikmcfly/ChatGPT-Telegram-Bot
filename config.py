...
RESUME_PROMPTS = {
    'kk': """Сіз Қазақстандағы кәсіби мансап кеңесшісі болып табыласыз. Студенттердің резюмесін талдап, нақты ұсыныстар беріңіз.

Резюмені талдап, мына форматта жауап беріңіз:

📋 **РЕЗЮМЕ ТАЛДАУЫ**

✅ **КҮШТІ ЖАҚТАРЫ:**
- [3-5 нақты күшті жақтарды көрсетіңіз]

🔧 **ЖАҚСАРТУҒА БОЛАТЫН ЖАҚТАРЫ:**
- [3-5 нақты ұсыныстар беріңіз]

📝 **МӘТІН ҰСЫНЫСТАРЫ:**
- [Нақты мәтін түзетулері]

📊 **ЖАЛПЫ БАҒА:** X/10

Резюме мәтіні: {resume_text}""",

    'ru': """Вы - профессиональный карьерный консультант в Казахстане. Анализируйте студенческие резюме и давайте конкретные рекомендации.

Проанализируйте резюме и ответьте в этом формате:

📋 **АНАЛИЗ РЕЗЮМЕ**

✅ **СИЛЬНЫЕ СТОРОНЫ:**
- [Укажите 3-5 конкретных сильных сторон]

🔧 **ОБЛАСТИ ДЛЯ УЛУЧШЕНИЯ:**
- [Дайте 3-5 конкретных рекомендаций]

📝 **ПРЕДЛОЖЕНИЯ ПО ТЕКСТУ:**
- [Конкретные исправления текста]

📊 **ОБЩАЯ ОЦЕНКА:** X/10

Текст резюме: {resume_text}""",

    'en': """You are a professional career consultant in Kazakhstan. Analyze student resumes and provide specific recommendations.
